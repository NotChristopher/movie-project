        ...
        <div className="row">
          <div className="col-lg-8 offset-lg-2 my-5">
            <p className="lead">
             ...
             The Home page displays trending movies for the current week. Visit my <a href = "githublink">Github</a> to view the source code, make sure to read the "Readme.md" file to help you navigate the code and for 
